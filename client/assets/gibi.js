...
var button_Add_Gibi = document.querySelector('.button-add-gibi')//botao q adiciona os gibis TEM Q BOTAR AQ PQ SENAO N TEM COMO PEGAR LA EMBAIXO
var eraserButton = document.querySelector('.eraser-Button');//botao q tira o Formulario TEM Q BOTAR AQ PQ SENAO N TEM COMO PEGAR LA EMBAIXO
form_Add_Box.removeChild(formAdd); // tira o formulario
...
const adicionar_gibi = () => { // funcão do botao
...
button_Add_Gibi.addEventListener('click',adicionar_gibi) // adiciona funcão do botao
